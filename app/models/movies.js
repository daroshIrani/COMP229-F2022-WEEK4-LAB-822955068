...
// code that lets you Create Replace Update Delete command the db - you can create custom schemas so you can define the datat storage in the mongo db 
...
export default mongoose.model('Movies',MovieSchema); // exporting the schema as set above as 'Movies' - same as 'export default indexRouter'